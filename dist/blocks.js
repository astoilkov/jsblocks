  ...
  */
  var blocks = function (value) {
    if (core.expressionsCreated) {
      ...
      return core.createExpression(value);  //return core.createExpression(blocks.unwrap(value));
    }
    return value;
  };
  ...
  blocks.extend = function () {
    var __METHOD_ID = 1;
    if (blocks.debug && blocks.debug.available()) {
      blocks.debug.checkArgs(blocks.debug.methods[__METHOD_ID], Array.prototype.slice.call(arguments), {});
    }
  ...
  function internalClone(value, deepClone, history) {
    ...
    if (blocks.isFunction(value.clone)) {
      ...
      case 'array':
        ...
        break;
      case 'date':
        clone = new Date(value.getFullYear(), value.getMonth(), value.getDate(), value.getHours(), value.getMinutes(), value.getSeconds(), value.getMilliseconds());
        break;
      case 'regexp':
        var flags = '';
        if (value.global) {
  ...
  blocks.eachRight = function (collection, callback, thisArg) {
    ...
    var length = collection.length, indexOrKey = collection.length, isCollectionAnArray = typeof length == 'number';
    callback = parseCallback(callback, thisArg);
  ...
  blocks.extend(blocks, {
    ...
    toObject: function (array, values) {
      ...
      var result = {}, useValuesArray = arguments.length > 1 && values, i = 0, length = array.length, value;
      for (; i < length; i++) {
        value = array[i];
        if (blocks.isArray(value)) {
  ...
  function equals(a, b, aStack, bStack, deepEqual) {
    ...
    if (aCtor !== bCtor && !(blocks.isFunction(aCtor) && aCtor instanceof aCtor && blocks.isFunction(bCtor) && bCtor instanceof bCtor) && ('constructor' in a && 'constructor' in b)) {
      return false;
    }
...
blocks.debug.queries = {
  ...
  val: {
    ...
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['string', 'number', 'Array', 'undefined', 'null'],
        optional: false,
        isArguments: false,
...
}; blocks.debug.methods = {
  '1': {
    fullName: 'extend',
    name: 'extend',
    description: 'Copies properties from all provided objects into the first object parameter',
    params: [{
        name: 'deepCopy',
        rawName: '[deepCopy]',
        types: ['boolean'],
  ...
  '2': {
    fullName: 'each',
    name: 'each',
    description: 'Iterates over the collection',
    params: [{
        name: 'collection',
        rawName: 'collection',
        types: ['Array', 'Object'],
        ...
        optional: false,
        isArguments: false,
        description: 'The callback that will be executed for each element in the collection',
        defaultValue: '',
        value: ''
      }, {
        name: 'thisArg',
        ...
        code: {
          ...
          children: ['blocks.each([', {
              ...
              children: [{
                  ...
                  name: 'hljs-params',
                  children: ['value, index, collection']
                }, ') ']
            }, '{\n  ', {
              name: 'hljs-comment',
              children: ['// value is the current item (3, 1 and 4)']
            }, '\n  ', {
              name: 'hljs-comment',
              children: ['// index is the current index (0, 1 and 2)']
            }, '\n  ', {
              name: 'hljs-comment',
              children: ['// collection points to the array passed to the function - [3, 1, 4]']
            }, '\n});']
        },
        value: ''
      }],
  ...
  '3': {
    fullName: 'eachRight',
    name: 'eachRight',
    description: 'Iterates over the collection from end to start',
    params: [{
        name: 'collection',
        rawName: 'collection',
        types: ['Array', 'Object'],
    ...
    examples: [{
        ...
        code: {
          ...
          children: ['blocks.eachRight([', {
              ...
              name: 'hljs-comment',
              children: ['// value is the current item (4, 1 and 3)']
            }, '\n  ', {
              name: 'hljs-comment',
              children: ['// index is the current index (2, 1 and 0)']
            }, '\n  ', {
              name: 'hljs-comment',
              children: ['// collection points to the array passed to the function - [3, 1, 4]']
            }, '\n});']
  ...
  '4': {
    fullName: 'type',
    name: 'type',
    description: 'Determines the true type of an object',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The value for which to determine its type',
        defaultValue: '',
        value: ''
      }],
    returns: {
  ...
  '5': {
    fullName: 'is',
    name: 'is',
    description: 'Determines if a specific value is the specified type',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['*'],
    ...
    returns: {
      types: ['boolean'],
      description: 'If the value is from the specified type',
      value: ''
    },
    examples: [{
        language: 'javascript',
  ...
  '6': {
    fullName: 'has',
    name: 'has',
    description: 'Checks if a variable has the specified property.\n Uses hasOwnProperty internally',
    params: [{
        name: 'obj',
        rawName: 'obj',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The object to call hasOwnPrototype for',
        defaultValue: '',
        value: ''
      }, {
        name: 'key',
        ...
        optional: false,
        isArguments: false,
        description: 'The key to check if exists in the object',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['boolean'],
      description: 'Returns if the key exists in the provided object',
      value: ''
    },
    examples: [{
        language: 'javascript',
  ...
  '7': {
    fullName: 'unwrap',
    name: 'unwrap',
    description: 'Unwraps a jsblocks value to its raw representation.\n Unwraps blocks.observable() and blocks() values',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The value that will be unwrapped',
        defaultValue: '',
        value: ''
      }],
    returns: {
    ...
    examples: [{
        ...
        code: {
          name: '',
          children: ['blocks.unwrap(blocks.observable(', {
              name: 'hljs-number',
              children: ['314']
            }, '));\n', {
              name: 'hljs-comment',
              children: ['// -> 314']
            }, '\n\nblocks.unwrap(blocks([', {
              name: 'hljs-number',
              children: ['3']
            }, ', ', {
              name: 'hljs-number',
              ...
              name: 'hljs-string',
              children: ['\'a string or any other value will not be changed\'']
            }, ');\n', {
              name: 'hljs-comment',
              children: ['// -> \'a string or any other value will not be changed\'']
            }]
  ...
  '8': {
    fullName: '$unwrap',
    name: '$unwrap',
    description: 'Unwraps a jQuery instance and returns the first element',
    params: [{
        name: 'element',
        rawName: 'element',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'If jQuery element is specified it will be unwraped',
        defaultValue: '',
        value: ''
      }, {
        name: 'callback',
        ...
        optional: true,
        isArguments: false,
        description: 'Callback the element will be passed to.',
        defaultValue: '',
        value: ''
      }, {
        name: 'thisArg',
        ...
        optional: true,
        isArguments: false,
        description: 'The context the callback will be executed with',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['*'],
      description: 'The unwraped value',
      value: ''
    },
    examples: [{
        language: 'javascript',
  ...
  '9': {
    fullName: 'toArray',
    name: 'toArray',
    description: 'Converts a value to an array. Arguments object is converted to array\n and primitive values are wrapped in an array. Does nothing when value\n is already an array',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The value to be converted to an array',
        defaultValue: '',
        value: ''
      }],
    returns: {
  ...
  10: {
    fullName: 'toUnit',
    name: 'toUnit',
    description: 'Converts an integer or string to a unit.\n If the value could not be parsed to a number it is not converted',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['String', 'Number'],
        optional: false,
        isArguments: false,
        description: 'The value to be converted to the specified unit',
        defaultValue: '',
        value: ''
      }, {
        name: 'unit',
        ...
        optional: true,
        isArguments: false,
        description: 'Optionally provide a unit to convert to.\n Default value is \'px\'',
        defaultValue: '\'px\'',
        value: ''
      }],
    returns: undefined,
  ...
  11: {
    fullName: 'clone',
    name: 'clone',
    description: 'Clones value. If deepClone is set to true the value will be cloned recursively',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['*'],
        ...
        optional: true,
        isArguments: false,
        description: 'If true it will be a deep clone.',
        defaultValue: '',
        value: ''
      }],
    returns: {
    ...
    examples: [{
        ...
        code: {
          ...
          children: [{
              ...
              name: 'hljs-keyword',
              children: ['var']
            }, ' cloned = blocks.clone(array);\n', {
              name: 'hljs-comment',
              children: ['// -> [3, 1, 4]']
            }, '\n', {
              name: 'hljs-keyword',
              children: ['var']
            }, ' areEqual = array == cloned;\n', {
              name: 'hljs-comment',
              children: ['// -> false']
            }]
        },
  ...
  12: {
    fullName: 'isElements',
    name: 'isElements',
    description: 'Determines if the specified value is a HTML elements collection',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The value to check if it is elements collection',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['boolean'],
      description: 'Returns whether the value is elements collection',
      value: ''
    },
    examples: [],
    memberof: 'blocks'
  ...
  13: {
    fullName: 'isElement',
    name: 'isElement',
    description: 'Determines if the specified value is a HTML element',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The value to check if it is a HTML element',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['boolean'],
      description: 'Returns whether the value is a HTML element',
      value: ''
    },
    examples: [{
        language: 'javascript',
  ...
  14: {
    fullName: 'isBoolean',
    name: 'isBoolean',
    description: 'Determines if a the specified value is a boolean.',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The value to be checked if it is a boolean',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['boolean'],
      description: 'Whether the value is a boolean or not',
      value: ''
    },
    examples: [{
        language: 'javascript',
  ...
  15: {
    fullName: 'isObject',
    name: 'isObject',
    description: 'Determines if the specified value is an object',
    params: [{
        name: 'obj',
        rawName: 'obj',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The value to check for if it is an object',
        defaultValue: '',
        value: ''
      }],
    returns: {
  ...
  16: {
    fullName: 'isPlainObject',
    name: 'isPlainObject',
    description: 'Determines if a value is a object created using {} or new Object',
    params: [{
        name: 'obj',
        rawName: 'obj',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The value that will be checked',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['boolean'],
      description: 'Whether the value is a plain object or not',
      value: ''
    },
    examples: [{
        language: 'javascript',
  ...
  17: {
    fullName: 'bind',
    name: 'bind',
    description: 'Changes the this binding to a function and optionally passes additional parameters to the\n function',
    params: [{
        name: 'func',
        rawName: 'func',
        types: ['Function'],
        optional: false,
        isArguments: false,
        description: 'The function for which to change the this binding and optionally\n add arguments',
        defaultValue: '',
        value: ''
      }, {
        name: 'thisArg',
        ...
        optional: false,
        isArguments: false,
        description: 'The new this binding context value',
        defaultValue: '',
        value: ''
      }, {
        name: 'args',
        ...
        optional: true,
        isArguments: true,
        description: 'Optional arguments that will be passed to the function',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['Function'],
      description: 'The newly created function having the new this binding and optional\n arguments',
      value: ''
    },
    examples: [{
        language: 'javascript',
        code: {
          ...
          children: [{
              ...
              name: 'hljs-string',
              children: ['\'Hello bind method!\'']
            }, ');\n\nalert();\n', {
              name: 'hljs-comment',
              children: ['// -> alerts \'Hello bind method\'']
            }, '\n\n', {
              name: 'hljs-keyword',
              children: ['var']
            }, ' alertAll = blocks.bind(', {
              name: 'hljs-function',
              children: [{
                  name: 'hljs-keyword',
                  children: ['function']
              ...
              name: 'hljs-comment',
              children: ['// -> alerts \'My name is John Doe\'']
            }]
        },
        value: ''
      }],
  ...
  18: {
    fullName: 'toObject',
    name: 'toObject',
    description: 'Converts an array of keys and an array of values to an object.\n If no value array is specified the values will be set to true.',
    params: [{
        name: 'array',
        rawName: 'array',
        types: ['String[]', 'Object[]'],
        optional: false,
        isArguments: false,
        description: 'The array of keys or an array of\n                             objects containing objects with key and value properties.',
        defaultValue: '',
        value: ''
      }, {
        name: 'values',
  ...
  19: {
    fullName: 'pairs',
    name: 'pairs',
    description: 'Converts an given object into an array of objects with properties key and value.\n Where key is the property name in the original object and value is the value of the property.',
    params: [{
        name: 'obj',
        rawName: 'obj',
        types: ['Object'],
    ...
    examples: [{
        ...
        code: {
          ...
          children: [{
              ...
              name: 'hljs-comment',
              children: ['// -> [{key: a, value: 1}, {key: b, value: "someting"}]']
            }]
        },
        value: ''
      }]
  ...
  20: {
    fullName: 'flatten',
    name: 'flatten',
    description: 'Flattens an array of values.',
    params: [{
        name: 'collection',
        rawName: 'collection',
        types: ['Array'],
        ...
        name: 'shallow',
        rawName: '[shallow=false]',
        types: ['boolean'],
        optional: true,
        isArguments: false,
        description: 'If true makes the flatten shallow.',
        defaultValue: 'false',
        value: ''
      }],
    returns: {
      types: ['Array'],
      description: 'The flattend array.',
      value: ''
    },
    examples: [{
        language: 'javascript',
  ...
  21: {
    fullName: 'equals',
    name: 'equals',
    description: 'Determines if two values are deeply equal.\n Set deepEqual to false to stop recusively equality checking',
    params: [{
        name: 'a',
        rawName: 'a',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The first object to be campared',
        defaultValue: '',
        value: ''
      }, {
        name: 'b',
        ...
        optional: true,
        isArguments: false,
        description: 'Determines if the equality check will recursively check all\n child properties',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['boolean'],
      description: 'Whether the two values are equal',
      value: ''
    },
    examples: [{
        language: 'javascript',
  ...
  23: {
    fullName: 'at',
    name: 'at',
    description: 'Creates an array of elements from the specified indexes, or keys, of the collection. Indexes may be specified as individual arguments or as arrays of indexes.',
    params: [{
        name: '',
        rawName: '',
        types: [],
    ...
    examples: [{
        ...
        code: {
          ...
          children: ['blocks.flatten([', {
              ...
              name: 'hljs-comment',
              children: ['// using "_.pluck" callback shorthand']
            }, '\nblocks.flatten(characters, ', {
              name: 'hljs-string',
              children: ['\'pets\'']
            }, ');\n', {
              name: 'hljs-comment',
              children: ['// → [\'hoppy\', \'baby puss\', \'dino\']']
            }]
        },
        value: ''
      }],
  ...
  25: {
    fullName: 'indexOf',
    name: 'indexOf',
    description: 'Gets the index at which the first occurrence of value is found using strict equality for comparisons, i.e. ===.\n If the array is already sorted providing true for fromIndex will run a faster binary search',
    params: [{
        name: 'searchValue',
        rawName: 'searchValue',
        types: ['*'],
  ...
  26: {
    fullName: 'last',
    name: 'last',
    description: 'Gets the last element or last n elements of an array. If a callback is provided elements at the end of the array are returned as long as the callback returns truthy.\n The callback is bound to thisArg and invoked with three arguments; (value, index, array).\n If a property name is provided for callback the created "_.pluck" style callback will return the property value of the given element.\n If an object is provided for callback the created "_.where" style callback will return true for elements that have the properties of the given object, else false.',
    params: [{
        name: '',
        rawName: '',
        types: [],
    ...
    returns: {
      types: ['*'],
      description: 'Returns the last element(s) of array.',
      value: ''
    },
    examples: [{
        language: 'javascript',
        code: {
          ...
          children: ['blocks.last([', {
              ...
              name: 'hljs-comment',
              children: ['// using "_.pluck" callback shorthand']
            }, '\nblocks.pluck(_.last(characters, ', {
              name: 'hljs-string',
              children: ['\'blocked\'']
            }, '), ', {
              name: 'hljs-string',
              ...
              name: 'hljs-comment',
              children: ['// using "_.where" callback shorthand']
            }, '\nblocks.last(characters, { ', {
              name: 'hljs-string',
              children: ['\'employer\'']
            }, ': ', {
              name: 'hljs-string',
              ...
              name: 'hljs-comment',
              children: ['// → [{ \'name\': \'pebbles\', \'blocked\': true, \'employer\': \'na\' }]']
            }]
        },
        value: ''
      }],
  ...
  27: {
    ...
    name: 'lastIndexOf',
    description: 'Gets the index at which the last occurrence of value is found using strict equality for comparisons, i.e. ===. If fromIndex is negative, it is used as the offset from the end of the collection.\n\n If a property name is provided for callback the created "_.pluck" style callback will return the property value of the given element.\n\n If an object is provided for callback the created "_.where" style callback will return true for elements that have the properties of the given object, else false.',
    params: [{
        name: 'searchValue',
        rawName: 'searchValue',
        types: ['*'],
        ...
        name: '[fromIndex',
        rawName: '[fromIndex=array.length',
        types: ['number'],
        optional: false,
        isArguments: false,
        description: '1] - The index to search from.',
  ...
  29: {
    fullName: 'html',
    name: 'html',
    description: 'Gets or sets the inner HTML of the element.',
    params: [{
        name: 'html',
        rawName: '[html]',
        types: ['String'],
        optional: true,
        isArguments: false,
        description: 'The new html that will be set. Provide the parameter only if you want to set new html.',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['String', 'VirtualElement'],
      description: 'returns itself if it is used as a setter(no parameters specified)\n and returns the inner HTML of the element if it used as a getter .',
      value: ''
    },
    examples: []
  },
  30: {
    fullName: 'text',
    name: 'text',
    description: 'Gets or sets the inner text of the element.',
    params: [{
        name: 'text',
        rawName: '[text]',
        types: ['String'],
        optional: true,
        isArguments: false,
        description: 'The new text that will be set. Provide the parameter only if you want to set new text.',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['String', 'VirtualElement'],
      description: 'returns itself if it is used as a setter\n and returns the inner text of the element if it used as a getter (no parameters specified).',
      value: ''
    },
    examples: []
  },
  31: {
    fullName: 'attr',
    name: 'attr',
    description: 'Gets or sets an attribute value',
    params: [{
        name: 'attributeName',
        rawName: 'attributeName',
        types: ['String'],
        optional: false,
        isArguments: false,
        description: 'The attribute name to be set or retrieved.',
        defaultValue: '',
        value: ''
      }, {
        name: 'attributeValue',
        ...
        optional: true,
        isArguments: false,
        description: 'The value to be set to the attribute.',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['VirtualElement', 'String'],
      description: 'Returns the VirtualElement itself if you set an attribute.\n Returns the attribute name value if only the first parameter is specified.',
      value: ''
    },
    examples: []
  },
  32: {
    fullName: 'removeAttr',
    name: 'removeAttr',
    description: 'Removes a particular attribute from the VirtualElement',
    params: [{
        name: 'attributeName',
        rawName: 'attributeName',
        types: ['String'],
        optional: false,
        isArguments: false,
        description: 'The attributeName which will be removed',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['VirtualElement'],
      description: 'The VirtualElement itself',
      value: ''
    },
    examples: []
  },
  33: {
    fullName: 'css',
    name: 'css',
    description: 'Gets or sets a CSS property',
    params: [{
        name: 'name',
        rawName: 'name',
        types: ['String'],
        optional: false,
        isArguments: false,
        description: 'The CSS property name to be set or retrieved',
        defaultValue: '',
        value: ''
      }, {
        name: 'value',
        ...
        optional: true,
        isArguments: false,
        description: 'The value to be set to the CSS property',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['VirtualElement', 'String'],
      description: 'Returns the VirtualElement itself if you use the method as a setter.\n Returns the CSS property value if only the first parameter is specified.',
      value: ''
    },
    examples: []
  },
  34: {
    ...
    params: [{
        ...
        optional: false,
        isArguments: false,
        description: 'A single className,\n multiples separated by space or array of class names.',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['VirtualElement'],
      description: 'Returns the VirtualElement itself to allow chaining.',
      value: ''
    },
    examples: []
  },
  ...
  36: {
    fullName: 'hasClass',
    name: 'hasClass',
    description: 'Checks whether the element has the specified class name',
    params: [{
        name: 'className',
        rawName: 'className',
        types: ['string'],
    ...
    returns: {
      types: ['boolean'],
      description: 'Returns a boolean determining if element has\n the specified class name',
      value: ''
    },
    examples: []
  },
  37: {
    fullName: 'blocks-observable',
    name: 'blocks.observable',
    description: ' ',
    params: [{
        name: 'initialValue',
        rawName: 'initialValue',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The inital value of the observable. This value will also specify the functions the observable inherits (e.g. array specific functions). Do not change types of observables later.',
        defaultValue: '',
        value: ''
      }, {
        name: 'context',
        ...
        optional: true,
        isArguments: false,
        description: 'The context the observable will be bound to.',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['blocks.observable'],
      description: '',
      value: ''
    },
    examples: []
  ...
  38: {
    ...
    returns: {
      types: ['*'],
      description: 'The result of the extend or the observable itself',
      value: ''
    },
    examples: [{
        language: 'javascript',
        code: {
          name: '',
          children: ['blocks.observable.formatter = ', {
              name: 'hljs-function',
              children: [{
                  name: 'hljs-keyword',
                  children: ['function']
              ...
              name: 'hljs-comment',
              children: ['// extending using the formatter extender']
            }, '\n', {
              name: 'hljs-keyword',
              children: ['var']
  ...
  39: {
    fullName: 'reset',
    name: 'reset',
    description: 'Removes all items from the collection and replaces them with the new value provided.\n The value could be Array, observable array or jsvalue.Array',
    params: [{
        name: 'value',
        rawName: '[value]',
        ...
        optional: true,
        isArguments: false,
        description: 'The new value that will be populated',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['blocks.observable'],
      description: 'Returns the observable itself - return this;',
      value: ''
    },
    examples: [{
        language: 'javascript',
        code: {
          ...
          children: [{
              name: 'hljs-comment',
              children: ['// creates an observable array with [1, 2, 3] as values']
            }, '\n', {
              name: 'hljs-keyword',
              children: ['var']
              ...
              name: 'hljs-comment',
              children: ['// removes the previous values and fills the observable array with [5, 6, 7] values']
            }, '\nitems.reset([', {
              name: 'hljs-number',
              children: ['5']
            }, ', ', {
  ...
  40: {
    fullName: 'add',
    name: 'add',
    description: 'Adds values to the end of the observable array',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The values that will be added to the end of the array',
        defaultValue: '',
        value: ''
      }, {
        name: 'index',
        ...
        optional: true,
        isArguments: false,
        description: 'Optional index specifying where to insert the value',
        defaultValue: '',
        value: ''
      }],
    returns: {
    ...
    examples: [{
        ...
        code: {
          ...
          children: [{
              ...
              name: 'hljs-comment',
              children: ['// results in observable array with [1, 2, 3, 4] values']
            }, '\nitems.add(', {
              name: 'hljs-number',
              children: ['4']
            }, ');']
  ...
  41: {
    fullName: 'addMany',
    name: 'addMany',
    description: 'Adds the values from the provided array(s) to the end of the collection',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['Array'],
        optional: false,
        isArguments: false,
        description: 'The array that will be added to the end of the array',
        defaultValue: '',
        value: ''
      }, {
        name: 'index',
        ...
        optional: true,
        isArguments: false,
        description: 'Optional position where the array of values to be inserted',
        defaultValue: '',
        value: ''
      }],
    returns: {
    ...
    examples: [{
        ...
        code: {
          ...
          children: [{
              ...
              name: 'hljs-comment',
              children: ['// results in observable array with [1, 2, 3, 4, 5, 6] values']
            }, '\nitems.addMany([', {
              name: 'hljs-number',
              children: ['4']
            }, ', ', {
  ...
  42: {
    ...
    params: [{
        ...
        optional: false,
        isArguments: false,
        description: 'The first index that points to the index in the array that will be swapped',
        defaultValue: '',
        value: ''
      }, {
        name: 'indexB',
        ...
        optional: false,
        isArguments: false,
        description: 'The second index that points to the index in the array that will be swapped',
        defaultValue: '',
        value: ''
      }],
    returns: {
  ...
  43: {
    fullName: 'move',
    name: 'move',
    description: 'Moves an item from one location to another in the array.\n Note: Faster than removing the item and adding it at the location',
    params: [{
        name: 'sourceIndex',
        rawName: 'sourceIndex',
        types: ['number'],
        optional: false,
        isArguments: false,
        description: 'The index pointing to the item that will be moved',
        defaultValue: '',
        value: ''
      }, {
        name: 'targetIndex',
        ...
        optional: false,
        isArguments: false,
        description: 'The index where the item will be moved to',
        defaultValue: '',
        value: ''
      }],
    returns: {
    ...
    examples: [{
        ...
        code: {
          ...
          children: [{
              ...
              name: 'hljs-comment',
              children: ['// results in observable array with [1, 2, 3, 4, 5] values']
            }, '\nitems.move(', {
              name: 'hljs-number',
              children: ['1']
            }, ', ', {
  ...
  44: {
    fullName: 'remove',
    name: 'remove',
    description: 'Removes an item from the observable array',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['Function', '*'],
  ...
  45: {
    ...
    params: [{
        ...
        optional: false,
        isArguments: false,
        description: 'The index location of the item that will be removed',
        defaultValue: '',
        value: ''
      }, {
        name: 'count',
        ...
        optional: true,
        isArguments: false,
        description: 'Optional parameter that if specified will remove\n the next items starting from the specified index',
        defaultValue: '',
        value: ''
      }],
    returns: {
  ...
  46: {
    fullName: 'removeAll',
    name: 'removeAll',
    description: 'Removes all items from the observable array and optionally filter which items\n to be removed by providing a callback',
    params: [{
        name: 'callbackOrValue',
        rawName: '[callbackOrValue]',
        types: ['Function', '*'],
        optional: true,
        isArguments: false,
        description: 'Optional callback function which filters which items\n to be removed. Returning a truthy value will remove the item and vice versa.\n If the passed value is not a function value matching the passed value will be removed.',
        defaultValue: '',
        value: ''
      }, {
        name: 'thisArg',
        ...
        optional: true,
        isArguments: false,
        description: 'Optional this context for the callback function',
        defaultValue: '',
        value: ''
      }, {
        name: 'removeOne',
        ...
        optional: true,
        isArguments: false,
        description: 'If set only the first entry will be removed. Mostly used in internal functions.',
        defaultValue: '',
        value: ''
      }],
    returns: {
  ...
  47: {
    fullName: 'concat',
    name: 'concat',
    description: 'The concat() method is used to join two or more arrays',
    params: [{
        name: 'arrays',
        rawName: 'arrays',
        types: ['...Array'],
        optional: false,
        isArguments: true,
        description: 'The arrays to be joined',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['Array'],
      description: 'The joined array',
      value: ''
    },
    examples: [],
    memberof: 'array'
  ...
  48: {
    fullName: 'slice',
    name: 'slice',
    description: 'The slice() method returns the selected elements in an array, as a new array object',
    params: [{
        name: 'start',
        rawName: 'start',
        types: ['number'],
        optional: false,
        isArguments: false,
        description: 'An integer that specifies where to start the selection (The first element has an index of 0)',
        defaultValue: '',
        value: ''
      }, {
        name: 'end',
        ...
        optional: true,
        isArguments: false,
        description: 'An integer that specifies where to end the selection. If omitted, all elements from the start\n position and to the end of the array will be selected. Use negative numbers to select from the end of an array',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['Array'],
      description: 'A new array, containing the selected elements',
      value: ''
    },
    examples: [],
    memberof: 'array'
  ...
  49: {
    fullName: 'join',
    name: 'join',
    description: 'The join() method joins the elements of an array into a string, and returns the string',
    params: [{
        name: 'seperator',
        rawName: '[seperator=\',\']',
        types: ['string'],
        optional: true,
        isArguments: false,
        description: 'The separator to be used. If omitted, the elements are separated with a comma',
        defaultValue: '\',\'',
        value: ''
      }],
    returns: {
      types: ['string'],
      description: 'The array values, separated by the specified separator',
      value: ''
    },
    examples: [],
    memberof: 'array'
  ...
  50: {
    fullName: 'push',
    name: 'push',
    description: 'The push() method adds new items to the end of the observable array, and returns the new length',
    params: [{
        name: 'values',
        rawName: 'values',
        types: ['...*'],
        optional: false,
        isArguments: true,
        description: 'The item(s) to add to the observable array',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['number'],
      description: 'The new length of the observable array',
      value: ''
    },
    examples: [],
    memberof: 'array'
  ...
  51: {
    ...
    returns: {
      types: ['Array'],
      description: 'The Array object, with the items sorted',
      value: ''
    },
    examples: [],
    memberof: 'array'
  ...
  52: {
    fullName: 'splice',
    name: 'splice',
    description: 'Adds and/or removes elements from the observable array',
    params: [{
        name: 'index',
        rawName: 'index',
        types: ['number'],
        optional: false,
        isArguments: false,
        description: 'An integer that specifies at what position to add/remove items.\n Use negative values to specify the position from the end of the array.',
        defaultValue: '',
        value: ''
      }, {
        name: 'howMany',
    ...
    returns: {
      types: ['Array'],
      description: 'A new array containing the removed items, if any.',
      value: ''
    },
    examples: [],
    memberof: 'array'
  ...
  53: {
    fullName: 'unshift',
    name: 'unshift',
    description: 'The unshift() method adds new items to the beginning of an array, and returns the new length.',
    params: [{
        name: 'The',
        rawName: 'The',
        types: ['...*'],
        optional: false,
        isArguments: true,
        description: 'new items that will be added to the beginning of the observable array.',
        defaultValue: '',
        value: ''
      }],
    returns: {
  ...
  54: {
    fullName: 'filter',
    name: 'filter',
    description: 'Extends the observable by adding a .view property which is filtered\n based on the provided options',
    params: [{
        name: 'options',
        rawName: 'options',
        types: ['Function', 'Object', 'String'],
        optional: false,
        isArguments: false,
        description: 'provide a callback function\n which returns true or false, you could also provide an observable',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['blocks.observable'],
      description: 'Returns a new observable\n containing a .view property with the filtered data',
      value: ''
    },
    examples: [],
    memberof: 'extenders'
  ...
  55: {
    fullName: 'skip',
    name: 'skip',
    description: 'Extends the observable by adding a .view property in which the first n\n items are skipped',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['number', 'blocks.observable', 'Function'],
        optional: false,
        isArguments: false,
  ...
  56: {
    fullName: 'take',
    name: 'take',
    description: 'Extends the observable by adding a .view property in which there is\n always maximum n items',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['number', 'blocks.observable', 'Function'],
        optional: false,
        isArguments: false,
        description: 'The max number of items to be in the collection',
        defaultValue: '',
        value: ''
      }],
    returns: {
  ...
  57: {
    fullName: 'sort',
    name: 'sort',
    description: 'Extends the observable by adding a .view property which is sorted\n based on the provided options',
    params: [{
        name: 'options',
        rawName: 'options',
        ...
        optional: false,
        isArguments: false,
        description: 'provide a callback sort function or field name to be sorted',
        defaultValue: '',
        value: ''
      }],
    returns: {
  ...
  58: {
    ...
    params: [{
        ...
        optional: false,
        isArguments: false,
        description: 'The model that will be used to query the DOM.',
        defaultValue: '',
        value: ''
      }, {
        name: 'element',
        rawName: '[element=document.body]',
        types: ['HTMLElement'],
        optional: true,
        isArguments: false,
        description: 'Optional element on which to execute the query.',
  ...
  59: {
    fullName: 'context',
    name: 'context',
    description: 'Gets the context for a particular element. Searches all parents until it finds the context.',
    params: [{
        name: 'element',
        rawName: 'element',
        types: ['HTMLElement', 'blocks.VirtualElement'],
        optional: false,
        isArguments: false,
        description: 'The element from which to search for a context',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['Object'],
      description: 'The context object containing all context properties for the specified element',
      value: ''
    },
    examples: [{
        language: 'html',
        code: {
          ...
          children: [{
              ...
              children: ['\n  blocks.query({\n    items: [', {
                  ...
                  name: 'hljs-string',
                  children: ['\'Clicked an item with index:\'']
                }, ' + blocks.context(e.target).$index);\n    }\n  });\n']
            }, {
              name: 'hljs-tag',
              children: ['</', {
                  name: 'hljs-name',
  ...
  60: {
    fullName: 'dataItem',
    name: 'dataItem',
    description: 'Gets the associated dataItem for a particlar element. Searches all parents until it finds the context',
    params: [{
        name: 'element',
        rawName: 'element',
        types: ['HTMLElement', 'blocks.VirtualElement'],
        optional: false,
        isArguments: false,
        description: 'The element from which to search for a dataItem',
        defaultValue: '',
        value: ''
      }],
    returns: {
        ...
        code: {
          ...
          children: [{
              ...
              children: ['\n  blocks.query({\n    items: [', {
                  ...
                  name: 'hljs-string',
                  children: ['\'Clicked the value: \'']
                }, ' + blocks.dataItem(e.target));\n    }\n  });\n']
            }, {
              name: 'hljs-tag',
              children: ['</', {
                  name: 'hljs-name',
  ...
  61: {
    fullName: 'isObservable',
    name: 'isObservable',
    description: 'Determines if particular value is an blocks.observable',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The value to check if the value is observable',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['boolean'],
      description: 'Returns if the value is observable',
      value: ''
    },
    examples: [{
        language: 'javascript',
        code: {
          name: '',
          children: ['blocks.isObservable(blocks.observable(', {
              name: 'hljs-number',
              children: ['3']
            }, '));\n', {
              name: 'hljs-comment',
  ...
  62: {
    fullName: 'unwrapObservable',
    name: 'unwrapObservable',
    description: 'Gets the raw value of an observable or returns the value if the specified object is not an observable',
    params: [{
        name: 'value',
        rawName: 'value',
        types: ['*'],
        optional: false,
        isArguments: false,
        description: 'The value that could be any object observable or not',
        defaultValue: '',
        value: ''
      }],
    returns: {
    ...
    examples: [{
        ...
        code: {
          name: '',
          children: ['blocks.unwrapObservable(blocks.observable(', {
              name: 'hljs-number',
              children: ['304']
            }, '));\n', {
              name: 'hljs-comment',
              children: ['// -> 304']
            }, '\n\nblocks.unwrapObservable(', {
              name: 'hljs-number',
              children: ['305']
            }, ');\n', {
              name: 'hljs-comment',
  ...
  63: {
    fullName: 'executeExpression',
    name: 'executeExpression',
    description: 'Executes expressions on a specified context.',
    params: [{
        name: '',
        rawName: '',
        types: [],
    ...
    examples: [{
        ...
        code: {
          ...
          children: [{
              ...
              name: 'hljs-comment',
              children: ['// -> [{observables: [], value: "Hello ", result: "Hello "},']
            }, '\n', {
              name: 'hljs-comment',
              children: ['//    {observables: [observable<"world">], value: observable<"world">, result: "world"},']
            }, '\n', {
              name: 'hljs-comment',
              children: ['//    {observable: [], value: "!", result: "!"}]']
            }]
        },
        value: ''
      }]
  ...
  64: {
    ...
    params: [{
        ...
        optional: true,
        isArguments: false,
        description: 'The object from which the new values will be applied',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['Model'],
      description: 'Chainable. Returns itself',
      value: ''
    },
    examples: [],
    memberof: 'Model'
  ...
  65: {
    fullName: 'read',
    name: 'read',
    description: 'Fires a request to the server to populate the Model based on the read URL specified',
    params: [{
        name: 'params',
        rawName: '[params]',
        types: ['Object'],
        optional: true,
        isArguments: false,
        description: 'The parameters Object that will be used to populate the\n Model from the specified options.read URL. If the URL does not contain parameters',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['Model'],
      description: 'Chainable. Returns the Model itself - returns this;',
      value: ''
    },
    examples: [],
    memberof: 'Model'
  ...
  66: {
    fullName: 'sync',
    name: 'sync',
    description: 'Synchronizes the changes with the server by sending requests to the provided URL\'s',
    params: [{
        name: 'callback',
        rawName: '[callback]',
        types: ['Function'],
        optional: true,
        isArguments: false,
        description: 'Optional callback which will be executed\n when all sync operations have been successfully completed',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['Model'],
      description: 'Returns the Model itself - return this;',
      value: ''
    },
    examples: [],
    memberof: 'Model'
  ...
  67: {
    ...
    params: [{
        ...
        optional: true,
        isArguments: false,
        description: 'A callback function that will be called when the data is available.',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['Collection'],
      description: 'Chainable. Returns the Collection itself - return this;',
      value: ''
    },
    examples: [{
        language: 'javascript',
        code: {
          ...
          children: [{
              ...
              name: 'hljs-string',
              children: ['\'http://your-servrice-url/{{id}}\'']
            }, '\n    }\n  }\n});\n\n', {
              name: 'hljs-keyword',
              children: ['var']
            }, ' products = Products().read({\n  ', {
              name: 'hljs-comment',
              children: ['// the id that will be replaced in the above options.read URL']
            }, '\n  id: ', {
              name: 'hljs-number',
              children: ['3']
            }, '\n});']
  ...
  68: {
    fullName: 'sync',
    name: 'sync',
    description: 'Performs an ajax request for all create, update and delete operations in order to sync them\n with a database.',
    params: [{
        name: 'callback',
        rawName: '[callback]',
        types: ['Function'],
    ...
    examples: [{
        ...
        code: {
          ...
          children: [{
              ...
              name: 'hljs-string',
              children: ['\'serviceURL/CreateProduct\'']
            }, '\n    }\n  }\n});\n\nApp.View(', {
              name: 'hljs-string',
              children: ['\'Products\'']
            }, ', ', {
              ...
              name: 'hljs-comment',
              children: ['// sends AJAX request to the create.url with the new item']
            }, '\n    ', {
              name: 'hljs-keyword',
              children: ['this']
            }, '.products.sync();\n  }\n});']
  ...
  69: {
    fullName: 'update',
    name: 'update',
    description: 'Performs updates on elements, expressions, etc. like obervable.update() when called without arguments.',
    params: [{
        name: 'id',
        rawName: '[id]',
        types: ['number'],
        optional: true,
        isArguments: false,
        description: 'The id of the element to trigger the update for',
        defaultValue: '',
        value: ''
      }, {
        name: 'newValues',
  ...
  70: {
    fullName: 'route',
    name: 'route',
    description: 'Routes to a specific URL and actives the appropriate views associated with the URL',
    params: [{
        name: 'name',
        rawName: 'name',
        types: ['String'],
    ...
    returns: {
      types: ['View'],
      description: 'Chainable. Returns this',
      value: ''
    },
    examples: [{
        language: 'javascript',
  ...
  71: {
    fullName: 'Property',
    name: 'Property',
    description: 'Creates an application property for a Model',
    params: [{
        name: 'property',
        rawName: '[property]',
        types: ['Object'],
        optional: true,
        isArguments: false,
        description: 'An object describing the options for the current property',
        defaultValue: '',
        value: ''
      }],
    returns: undefined,
  ...
  72: {
    ...
    params: [{
        ...
        optional: false,
        isArguments: false,
        description: 'the Model object properties that will be created',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['Model'],
      description: 'the Model type with the specified properties',
      value: ''
    },
    examples: [{
        language: 'javascript',
  ...
  73: {
    ...
    params: [{
        name: 'ModelType',
        rawName: '[ModelType]',
        types: ['Object', 'blocks.Application.Model'],
        optional: true,
        isArguments: false,
        description: 'The model type the collection will be created for.',
        defaultValue: '',
        value: ''
      }, {
        name: 'prototype',
        ...
        optional: false,
        isArguments: false,
        description: 'The Collection object properties that will be created.',
        defaultValue: '',
        value: ''
      }],
    returns: {
      types: ['Collection'],
      description: 'The Collection type with the specified properties',
      value: ''
    },
    examples: [{
        language: 'javascript',
  ...
  74: {
    fullName: 'View',
    name: 'View',
    description: 'Defines a view that will be part of the Application',
    params: [{
        name: 'parentViewName',
        rawName: '[parentViewName]',
        types: ['string'],
        optional: true,
        isArguments: false,
        description: 'Provide this parameter only if you are creating nested views.\n This is the name of the parent View',
        defaultValue: '',
        value: ''
      }, {
        name: 'name',
        ...
        optional: false,
        isArguments: false,
        description: 'The name of the View you are creating',
        defaultValue: '',
        value: ''
      }, {
        name: 'prototype',
        ...
        optional: false,
        isArguments: false,
        description: 'The object that will represent the View',
        defaultValue: '',
        value: ''
      }],
    returns: undefined,
  ...
  (function () {
    ...
    */
      ...
      resolveFilterExpressionValue: function (result, value, filterExpression) {
        if (filterExpression.field && filterExpression.operator) {
          ...
          if (result && filterExpression.logic == 'or') {
            ...
            var currentResult = false, length = filterExpression.filters.length, i = 0;
            for (; i < length; i++) {
    ...
    for (var key in CollectionDescriptors) {
      CollectionDescriptors[key].identity = key;
      CollectionDescriptors[key].parent = CollectionDescriptors;
    }
    ...
    for (var key in ArrayDescriptors) {
      ArrayDescriptors[key].identity = key;
      ArrayDescriptors[key].parent = ArrayDescriptors;
    }
    ...
    for (var key in ObjectDescriptors) {
      ObjectDescriptors[key].identity = key;
      ObjectDescriptors[key].parent = ObjectDescriptors;
    }
    var LoopDescriptors = {
    ...
    blocks.extend(staticMethods, {
      ...
      concat: function () {
        ...
        return new expressions.RootArrayExpression(value.concat.apply(value, arguments));  //return new expressionsCache.RootArrayExpression(this.value().concat(slice.call(arguments)));
      },
      push: function () {
        var value = this.value();
    ...
    function generateExpression(name, path, descriptorName, type, isRoot) {
      ...
      var Expression = new Function([
        ...
        'add',
        'NumberExpression'
      ], body)(blocks, blocks, expressionsCache, cache, BaseExpression, LoopDescriptors, generateExpression, descriptors2, createExpression, PrepareValues, slice, add, NumberExpression);
      if (isRoot) {
    ...
    */
    ...
    blocks.extend(blocks, {
      ...
      equalsTime: function (dateA, dateB) {
        return dateA.getHours() === dateB.getHours() && dateA.getMinutes() === dateB.getMinutes() && dateA.getSeconds() === dateB.getSeconds() && dateA.getMilliseconds() === dateB.getMilliseconds();
      },
    ...
    var skipMethods = blocks.toObject([
      'value',
      'not',
      'and',
      'or',
    ...
    function createExpression(expression) {
      ...
      var types = isSingleExpression ? [
        'array',
        'object'
      ] : [expression._type == 1 ? 'array' : 'object'];
      ...
      if (isSingleExpression) {
        ...
        if (typeof module === 'object' && typeof module.exports === 'object') {
          func = new Function([
            'blocks',
            'collection'
          ].concat(context.args[0]), expression._loopDescriptor(context));
          return function () {
        ...
        if (typeof module === 'object' && typeof module.exports === 'object') {
          func = new Function([
            'blocks',
            context.expression
          ], expression._loopDescriptor(context));
    ...
    function mock(descriptor) {
      var root = { _loopDescriptor: LoopDescriptors[descriptor.identity] || LoopDescriptors.singleExpression };
      var expression = {
        _parent: root,
    ...
    var Expression = function () {
      ...
      var Expression = {
        ...
        Execute: function (context, elementData, expressionData, entireExpression, type) {
          ...
          func = parameterQueryCache[expression] = parameterQueryCache[expression] || new Function('c', 'with(c){with($this){ return ' + expression + '}}' + '//# sourceURL=' + encodeURI(entireExpression.text));
          ...
          array: {
            ...
            reset: function (array) {
              ...
              if (!blocks.isArray(array) && !!array) {
                blocks.debug.throwMessage('Array-Observables can not be reseted to a non array type! Reset got aborted.', blocks.debug.methods[__METHOD_ID] || null, 'Warning');
      ...
      Application.prototype = {
        ...
        */
        ...
        View: function (name, prototype, nestedViewPrototype) {
          ...
          if (this._started) {
            blocks.debug.throwMessage('Views can not be constructed / added after the application has been started. Try to add your views synchronous before document.readyState is "complete".', blocks.debug.methods[__METHOD_ID] || null, 'Error');
